...
func _initialize() -> void:
	...
	await _settle_frames(1)
	_assert(game.quests.is_objective_done("main_road_of_crows", "bram"), "Tracks did not safely recover Bram evidence")
	_assert(game.quests.is_objective_done("main_road_of_crows", "vargan_wire"), "Tracks did not safely recover Vargan evidence")
	_assert(game.quests.is_objective_done("main_road_of_crows", "sella"), "Tracks did not safely recover Sella evidence")
	_assert(game.quests.is_objective_done("main_road_of_crows", "evidence_ready"), "Evidence threshold did not resolve")
