...
try {
    ...
    $verifiers = @(
		...
		"verify_recovery_002_foundation.gd", "verify_navigation_001.gd", "verify_char_001.gd", "verify_anim_001.gd", "verify_world_001.gd", "verify_world_002.gd", "verify_zone_budgets.gd",
